...
jsPsych.plugins["audio-likert-jedit"] = (function () {
  var plugin = {};
  ...
  plugin.trial = function (display_element, trial) {
    ...
    html +=
      ".jspsych-survey-likert-statement { display:block; font-size: 16px; padding-top: 3px; margin-bottom:3px; }" +
      ".jspsych-survey-likert-opts { list-style:none; width:" +
      w +
      "; margin:auto; padding:0 0 10px; display:block; font-size: 14px; line-height:1.1em; }" +
    ...
    // add submit button
    html +=
      '<input type="button" id="jspsych-survey-likert-replay" class="jspsych-survey-likert jspsych-btn" style="cursor: pointer; display: inline-block; margin: 0 8" value="Replay"></input>';
    html +=
    ...
    display_element
      .querySelector("#jspsych-survey-likert-replay")
